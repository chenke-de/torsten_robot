 ...
 *
 * $Id: pcbtrace.h 27 2016-01-12 14:41:33Z Fabrice $
 *
 */
...
struct pcbtrace_ctx {
	...
	char filename[PCBTRACE_MAX_CHAR_SIZE];	/**< name of the trace's file */
	uint idx;								/**< index of the file (for segmented traces) */
	ushort status;		/**< status of the tracer */
	ushort maxsize;		/**< maximum size of the trace file */
